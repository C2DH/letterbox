...
export type CountryItemsCountsFragment = { __typename?: 'Country', addressesCount: number, companiesCount: number, messagesCount: number, peopleCount: number };
...
export type GetCountryItemsCountsQuery = { __typename?: 'Query', result: Array<{ __typename?: 'Country', addressesCount: number, companiesCount: number, messagesCount: number, peopleCount: number }> };
...
export type GetCountryItemsCountsWithCommonsQuery = { __typename?: 'Query', result: Array<{ __typename?: 'Country', commonCompaniesCount: number, addressesCount: number, companiesCount: number, messagesCount: number, peopleCount: number }> };
