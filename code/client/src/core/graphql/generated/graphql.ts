...
export type QueryTimelineQueryVariables = Exact<{
  itemType: DataItemType;
  filters: SearchFilters;
}>;


export type QueryTimelineQuery = { __typename?: 'Query', aggregate: { __typename?: 'AggregateResults', total: number, values: Array<{ __typename?: 'AggregateValue', label: string, id: string, count: number }> } };
