...
export type GetAddressCompaniesQuery = { __typename?: 'Query', result: Array<{ __typename?: 'Address', companies: Array<{ __typename?: 'Company', id: string, name: string, addressesCount: number, countriesCount: number, messagesCount: number, peopleCount: number }> }> };
...
export type AggregateCompaniesQueryVariables = Exact<{ [key: string]: never; }>;
