...
type Documents = {
    ...
    "\n  fragment AddressItemsCounts on Address {\n    companiesCount\n    countriesCount\n    messagesCount\n    peopleCount\n    addressesCount\n  }\n": typeof types.AddressItemsCountsFragmentDoc,
    ...
    "\n  fragment PersonItemCounts on Person {\n    addressesCount\n    companiesCount\n    countriesCount\n    messagesCount\n    peopleCount\n  }\n": typeof types.PersonItemCountsFragmentDoc,
    ...
    "\n  query GetMessageItemsCounts($id: ID!) {\n    result: messages(where: { id_EQ: $id }) {\n      ...MessageItemsCounts\n    }\n  }\n": typeof types.GetMessageItemsCountsDocument,
...
const documents: Documents = {
    ...
    "\n  query GetCompanyCompanies($id: ID!, $skip: Int, $limit: Int) {\n    result: companies(where: { id_EQ: $id }) {\n      companies(skip: $skip, limit: $limit) {\n        ...CompanyInline\n      }\n    }\n  }\n": types.GetCompanyCompaniesDocument,
    ...
    "\n  query CountItemsWithPendingModifications {\n    nbItems: countItemsWithPendingModifications\n    onGoingIndexation: indexingPendingModifications {\n      startTime\n      nbItems\n    }\n  }\n": types.CountItemsWithPendingModificationsDocument,
    "\n  mutation Mutation {\n    result: indexPendingModifications {\n      message {\n        count\n        errors\n      }\n      company {\n        count\n        errors\n      }\n      person {\n        count\n        errors\n      }\n      address {\n        count\n        errors\n      }\n      country {\n        count\n        errors\n      }\n    }\n  }\n": types.MutationDocument,
    "\n  query GetMessageById($id: ID!) {\n    result: messages(where: { id_EQ: $id }) {\n      id\n      year\n      message\n      filename\n      pageNumber\n      deleted\n    }\n  }\n": types.GetMessageByIdDocument,
    "\n  query GetMessageItemsCounts($id: ID!) {\n    result: messages(where: { id_EQ: $id }) {\n      ...MessageItemsCounts\n    }\n  }\n": types.GetMessageItemsCountsDocument,
    ...
    "\n  query AggregateItems(\n    $itemType: DataItemType!\n    $field: AggregationFields!\n    $filters: SearchFilters!\n    $query: String\n    $includes: String\n    $limit: Int = 10\n  ) {\n    aggregate(\n      itemType: $itemType\n      field: $field\n      filters: $filters\n      query: $query\n      includes: $includes\n      size: $limit\n    ) {\n      total\n      values {\n        label\n        id\n        count\n      }\n    }\n  }\n": types.AggregateItemsDocument,
    "\n  query QueryMessagesTimeline($itemType: DataItemType!, $filters: SearchFilters!) {\n    aggregate(itemType: $itemType, field: year, filters: $filters, size: 1000) {\n      total\n      values {\n        label\n        id\n        count\n      }\n    }\n  }\n": types.QueryMessagesTimelineDocument,
    "\n  query QueryItemsTimeline($itemType: DataItemType!, $filters: SearchFilters!) {\n    aggregate(itemType: $itemType, field: years, filters: $filters, size: 1000) {\n      total\n      values {\n        label\n        id\n        count\n      }\n    }\n  }\n": types.QueryItemsTimelineDocument,
};
