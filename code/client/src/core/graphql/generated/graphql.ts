...
export type MessageInlineFragment = { __typename?: 'Message', id: string, year: number, message: string, addressesCount: number, companiesCount: number, countriesCount: number, peopleCount: number, tags?: Array<string | null> | null, deleted?: boolean | null, verified?: boolean | null, addresses: Array<{ __typename?: 'Address', id: string, name: string }>, companies: Array<{ __typename?: 'Company', id: string, name: string }>, countries: Array<{ __typename?: 'Country', id: string, name: string }>, people: Array<{ __typename?: 'Person', id: string, name: string }> };
